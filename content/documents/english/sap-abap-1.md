...
- **Custom Type**: GT*, GTS*, GTT\_
- **Constant**: GC\_
- **Global variables**: GD\_
- **Work Area (Structure)**: GS\_
- **Internal Table**: GT\_
- **Local variables**: LD\_
- **Local work area**: LS\_
- **Local internal table**: LT\_
- **Selection-screen Parameter**: P\_
- **Selection-screen Select-option**: S\_
- **Selection-screen Radio Button**: RB\_
- **Selection-screen Checkbox**: CB\_
- **Subroutines (Procedure)**: GET_DATA, SET_DATA
- **Global class**: ZCL, YCL
- **Local class**: LCL
- **Class instance (object)**: O, LO
- **Class methods**: GET_DATA, SET_DATA
- **Class attributes**: no prefix
...
### 7. Selection Screens & User Inputs
...
### 8. Program Events in Report Programs
...
### 9. Operations, Date/Time Arithmetic & System Variables
